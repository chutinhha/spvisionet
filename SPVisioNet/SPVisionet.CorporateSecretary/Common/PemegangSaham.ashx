<%@ WebHandler Language="C#" Class="PemegangSaham" %>
...
public class PemegangSaham : IHttpHandler {
    ...
    private void Bind(HttpContext context, string search)
    {
        ...
        using (SPSite site = new SPSite(SPContext.Current.Web.Url, SPContext.Current.Site.SystemAccount.UserToken))
        {
            ...
            {
                SPList list = web.GetList(Util.CreateSharePointListStrUrl(web.Url, "PemegangSaham"));
