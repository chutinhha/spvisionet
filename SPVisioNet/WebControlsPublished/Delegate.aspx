<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Delegate.aspx.cs" Inherits="SPVisionet.CorporateSecretary.WebControls.Delegate" %>
...
<body>
    ...
    <fieldset>
        ...
        <table cellspacing="0" cellpadding="4" border="0" width="100%">
            <tr>
                <td align="right">
                    <asp:Button ID="btnDelegate" runat="server" Text="Delegate" OnClick="btnDelegate_Click" />&nbsp;<asp:Button
                        ID="btnCancel" runat="server" Text="Close" ValidationGroup="Cancel" OnClientClick="javascript:window.close();" />
                </td>
            </tr>
        </table>
    </fieldset>
