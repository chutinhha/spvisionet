...
namespace SPVisioNet.NotifExpiredPermintaanDocument
{
        ...
        public void Process()
        {
            ...
            SPSecurity.RunWithElevatedPrivileges(delegate()
            {
                ...
                using (SPSite site = new SPSite(WebUrl))
                {
                    ...
                    {
                        emailTemplate = GetSettingValue(web, "Email", "NotifExpiredPermintaanDocument");
                        SPListItemCollection items = GetNotificationSetting(web, "NotifExpiredPermintaanDocument");
