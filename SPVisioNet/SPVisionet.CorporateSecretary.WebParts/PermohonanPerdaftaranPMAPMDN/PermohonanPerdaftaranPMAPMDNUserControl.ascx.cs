...
{
    public partial class PermohonanPerdaftaranPMAPMDNUserControl : UserControl
    {
        #region Properties
        ...
        private string Validation()
        {
            ...
            if (Convert.ToBoolean(ViewState["Admin"]) == true || ViewState["Status"].ToString() == string.Empty)
            {
                ...
                if (txtKlasifikasi.Text.Trim() == string.Empty)
                    sb.Append(SR.FieldCanNotEmpty("Klasifikasi Bidang Usaha") + " \\n");
        ...
        private string SaveUpdate(string mode)
        {
            ...
            try
            {
                ...
                {
                    item = list.Items.Add();
                    item["Title"] = Util.GenerateRequestCode(web, RequestCode.PENDAFTARAN_PMAPMDN, DateTime.Now.Month, DateTime.Now.Year);
                ...
                if (Convert.ToBoolean(ViewState["Admin"]) == true || ViewState["Status"].ToString() == string.Empty)
                {
                    ...
                    item["KlasifikasiBidangUsaha"] = txtKlasifikasi.Text.Trim();
        ...
        protected void dgPemegangSaham_ItemDataBound(object sender, DataGridItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Footer)
            {
                ...
                txtNamaPemegangSahamAdd.Attributes.Add("onkeyup", "PemegangSahamPendaftaranPMAPMDN('" + txtNamaPemegangSahamAdd.ClientID + "');");
            }
            else if (e.Item.ItemType == ListItemType.EditItem)
            {
                ...
                txtNamaPemegangSahamEdit.Attributes.Add("onkeyup", "PemegangSahamPendaftaranPMAPMDN('" + txtNamaPemegangSahamEdit.ClientID + "');");
            }
