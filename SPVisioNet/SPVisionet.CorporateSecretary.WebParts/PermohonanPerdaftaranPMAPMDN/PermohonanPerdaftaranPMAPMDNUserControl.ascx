...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PermohonanPerdaftaranPMAPMDNUserControl.ascx.cs" Inherits="SPVisionet.CorporateSecretary.WebParts.PermohonanPerdaftaranPMAPMDN.PermohonanPerdaftaranPMAPMDNUserControl" %>
<fieldset>
    <legend>
        <h3>
