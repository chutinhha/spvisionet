    ...
    <asp:UpdatePanel ID="upMain" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <table border="0">
                ...
                <tr>
                    <td>
                        Request Code <span style="color: Red">*</span>
                    </td>
                    <td>
                        :
                    </td>
            ...
            <ContentTemplate>
                <table border="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtKlasifikasiLapanganUsaha" runat="server" Width="400px" />
                            ...
                            <asp:Literal ID="ltrKlasifikasiLapanganUsaha" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td valign="top">
                        ...
                        <table border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:Literal ID="ltrKeteranganSIUP" runat="server" />
                                </td>
                            </tr>
                        </table>
                    </td>
