...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wpExpiredKomisarisUserControl.ascx.cs" Inherits="SPVisioNet.WebParts.wpExpiredKomisaris.wpExpiredKomisarisUserControl" %>
