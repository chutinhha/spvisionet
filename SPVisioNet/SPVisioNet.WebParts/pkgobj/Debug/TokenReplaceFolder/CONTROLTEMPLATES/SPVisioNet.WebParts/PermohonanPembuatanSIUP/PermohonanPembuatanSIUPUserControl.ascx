...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PermohonanPembuatanSIUPUserControl.ascx.cs"
    Inherits="SPVisioNet.WebParts.PermohonanPembuatanSIUP.PermohonanPembuatanSIUPUserControl" %>
<fieldset>
    <legend>
        <h3>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddAlasanPembuatan" runat="server">
                    ...
                    <asp:ListItem Text="Perubahan" Value="Perubahan"></asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
    </table>
    ...
    <fieldset>
        <legend><b>Laporan Pembuatan SIUP [Nama Perusahaan]
