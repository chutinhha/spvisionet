...
namespace SPVisioNet.WebParts
{
    public class MyUtil
    {
        ...
        {
            SPList list = web.GetList(MyUtil.CreateSharePointListStrUrl(web.Url, "KlasifikasiLapanganUsaha"));
        ...
        {
            SPList list = web.GetList(MyUtil.CreateSharePointListStrUrl(web.Url, "StatusPerseroan"));
        ...
        {
            SPList list = web.GetList(MyUtil.CreateSharePointListStrUrl(web.Url, "TempatKedudukan"));
        ...
        {
            SPList list = web.GetList(MyUtil.CreateSharePointListStrUrl(web.Url, "MaksudTujuan"));
        ...
        {
            SPList list = web.GetList(MyUtil.CreateSharePointListStrUrl(web.Url, "StatusOwnership"));
        ...
        {
            SPList list = web.GetList(MyUtil.CreateSharePointListStrUrl(web.Url, "MataUang"));
        ...
        {
            SPList list = web.GetList(MyUtil.CreateSharePointListStrUrl(web.Url, "TipeDokumen"));
        ...
        {
            SPList list = web.GetList(MyUtil.CreateSharePointListStrUrl(web.Url, "KomisarisDireksiJabatan"));
                ...
                using (SPSite site = new SPSite(web.Url))
                {
                    using (SPWeb webSA = site.OpenWeb())
                    {
                        ...
                        query.Query = "<Where>" +
                                        ...
                                        "</And>" +
                                      "</Where>";
                        SPListItemCollection itemConfig = webSA.GetList(CreateSharePointListStrUrl(webSA.Url, "Settings")).GetItems(query);
                        try
                        {
