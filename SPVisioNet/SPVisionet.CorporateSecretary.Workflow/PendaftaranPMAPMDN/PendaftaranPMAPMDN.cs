...
namespace SPVisionet.CorporateSecretary.Workflow.PendaftaranPMAPMDN
{
    public sealed partial class PendaftaranPMAPMDN : SequentialWorkflowActivity
    {
        ...
        private void onWorkflowActivated1_Invoked(object sender, ExternalDataEventArgs e)
        {
            ...
            WFNameID = Util.GetSettingValue(web, "Workflow Name", "Pendaftaran PMA/PMDN");
        ...
        private void PopulateData_ExecuteCode(object sender, EventArgs e)
        {
            ...
            createMultipleTask1_Subject1 = string.Format("CorsecSP {0} [ {1} ] Need Approval", RequestCode.PENDAFTARAN_PMAPMDN, workflowProperties.Item["NamaPerusahaan"].ToString());
            createMultipleTask1_Body1 = string.Format(EmailNotificationTemplate, "{0}", "Pendaftaran PMA/PMDN Task", workflowProperties.Item.Title, OriginatorName, "need your approval" + Util.GenerateApprovalInformation(scInfo), "{1}");
        ...
        private void PopulateDataChiefCoresec_ExecuteCode(object sender, EventArgs e)
        {
            ...
            createMultipleTaskChiefCorsec_Subject1 = string.Format("CorsecSP {0} [ {1} ] Need Approval", RequestCode.PENDAFTARAN_PMAPMDN, workflowProperties.Item["NamaPerusahaan"].ToString());
            createMultipleTaskChiefCorsec_Body1 = string.Format(EmailNotificationTemplate, "{0}", "Pendaftaran PMA/PMDN Task", workflowProperties.Item.Title, OriginatorName, "need your approval" + Util.GenerateApprovalInformation(scInfo), "{1}");
        ...
        private void PopulateDataOriginator_ExecuteCode(object sender, EventArgs e)
        {
            ...
            createMultipleTaskOriginator_Subject1 = string.Format("CorsecSP {0} [ {1} ] Need to Upload Document and Update Data", RequestCode.PENDAFTARAN_PMAPMDN, workflowProperties.Item["NamaPerusahaan"].ToString());
            createMultipleTaskOriginator_Body1 = string.Format(EmailNotificationOriginatorTemplate, "{0}", "Pendaftaran PMA/PMDN Task", workflowProperties.Item.Title, "need you to upload document and update data" + Util.GenerateApprovalInformation(scInfo), "{1}");
        ...
        private void SendMailApprove_ExecuteCode(object sender, EventArgs e)
        {
            ...
            string URL = string.Format("{0}/Lists/PendaftaranPMAPMDN/DispForm.aspx?ID={1}", workflowProperties.WebUrl, workflowProperties.Item.ID);
            Subject = string.Format("CorsecSP {0} [ {1} ] is already Completed", RequestCode.PENDAFTARAN_PMAPMDN, workflowProperties.Item["NamaPerusahaan"].ToString());
            ...
            foreach (string item in splitDivHead)
            {
                ...
                BodyMessage = string.Format(ApprovedRejectedMailTemplate, userDivHead.Name, "Pendaftaran PMA/PMDN", workflowProperties.Item.Title, "has been uploaded document and updated data by " + OriginatorName + Util.GenerateApprovalInformation(scInfo), URL);
            ...
            foreach (string item in splitChiefCorsec)
            {
                ...
                BodyMessage = string.Format(ApprovedRejectedMailTemplate, userCorsec.Name, "Pendaftaran PMA/PMDN", workflowProperties.Item.Title, "has been uploaded document and updated data by " + OriginatorName + Util.GenerateApprovalInformation(scInfo), URL);
        ...
        private void sendEmailReject_MethodInvoking(object sender, EventArgs e)
        {
            ...
            string URL = string.Format("{0}/Lists/PendaftaranPMAPMDN/EditForm.aspx?ID={1}", workflowProperties.WebUrl, workflowProperties.Item.ID);
            Subject = string.Format("CorsecSP {0} [ {1} ] Rejected", RequestCode.PENDAFTARAN_PMAPMDN, workflowProperties.Item["NamaPerusahaan"].ToString());

            BodyMessage = string.Format(ApprovedRejectedMailTemplate, OriginatorName, "Pendaftaran PMA/PMDN", workflowProperties.Item.Title, "has been rejected by " + RejectedName + Util.GenerateApprovalInformation(scInfo) + "<br/><br/>Remarks: " + Remarks, URL);
