...
namespace SPVisionet.CorporateSecretary.Workflow.PendirianPerusahaanBaruIndonesia
{
    public sealed partial class PendirianPerusahaanBaruIndonesia : SequentialWorkflowActivity
    {
        ...
        private void SendMailApprove_ExecuteCode(object sender, EventArgs e)
        {
            ...
            BodyMessage = string.Format(ApprovedRejectedMailTemplate, OriginatorName, "Pendirian Perusahaan Baru (Indonesia)", workflowProperties.Item.Title, "has been completed" + Util.GenerateApprovalInformation(scInfo), URL);
            ...
            foreach (string item in splitDivHead)
            {
                ...
                BodyMessage = string.Format(ApprovedRejectedMailTemplate, userDivHead.Name, "Pendirian Perusahaan Baru (Indonesia)", workflowProperties.Item.Title, "has been completed by " + OriginatorName + Util.GenerateApprovalInformation(scInfo), URL);
            ...
            foreach (string item in splitChiefCorsec)
            {
                ...
                BodyMessage = string.Format(ApprovedRejectedMailTemplate, userCorsec.Name, "Pendirian Perusahaan Baru (Indonesia)", workflowProperties.Item.Title, "has been completed by " + OriginatorName + Util.GenerateApprovalInformation(scInfo), URL);
            ...
            foreach (string item in splitTax)
            {
                ...
                BodyMessage = string.Format(ApprovedRejectedMailTemplate, userTax.Name, "Pendirian Perusahaan Baru (Indonesia)", workflowProperties.Item.Title, "has been completed by " + OriginatorName + Util.GenerateApprovalInformation(scInfo), URL);
            ...
            foreach (string item in splitAccounting)
            {
                ...
                BodyMessage = string.Format(ApprovedRejectedMailTemplate, userAccounting.Name, "Pendirian Perusahaan Baru (Indonesia)", workflowProperties.Item.Title, "has been completed by " + OriginatorName + Util.GenerateApprovalInformation(scInfo), URL);
            ...
            foreach (string item in splitFinance)
            {
                ...
                BodyMessage = string.Format(ApprovedRejectedMailTemplate, userFinance.Name, "Pendirian Perusahaan Baru (Indonesia)", workflowProperties.Item.Title, "has been completed by " + OriginatorName + Util.GenerateApprovalInformation(scInfo), URL);
        ...
        private void sendEmailReject_MethodInvoking(object sender, EventArgs e)
        {
            ...
            BodyMessage = string.Format(ApprovedRejectedMailTemplate, OriginatorName, "Pendirian Perusahaan Baru (Indonesia)", workflowProperties.Item.Title, "has been rejected by " + RejectedName + Util.GenerateApprovalInformation(scInfo) + "<br/><br/>Remarks: " + Remarks, URL);
