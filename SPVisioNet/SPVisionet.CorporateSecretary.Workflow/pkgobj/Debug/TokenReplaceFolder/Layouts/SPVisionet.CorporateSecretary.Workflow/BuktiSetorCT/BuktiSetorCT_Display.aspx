...
<%@ Page Language="C#" DynamicMasterPageFile="~masterurl/default.master" AutoEventWireup="true"
    Inherits="SPVisionet.CorporateSecretary.Workflow.Layouts.SPVisionet.CorporateSecretary.Workflow.BuktiSetorCT.BuktiSetorCT_Display"
    CodeBehind="BuktiSetorCT_Display.aspx.cs" %>
    ...
    <fieldset>
        ...
        <table border="0" width="100%">
            ...
            <tr>
                ...
                <td>
                    <asp:Literal ID="ltlBuktiSetor" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
