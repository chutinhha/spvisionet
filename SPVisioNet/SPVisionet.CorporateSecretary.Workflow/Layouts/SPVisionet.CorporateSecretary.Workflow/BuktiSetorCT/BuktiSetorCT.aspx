...
<%@ Page Language="C#" DynamicMasterPageFile="~masterurl/default.master" AutoEventWireup="true"
    Inherits="SPVisionet.CorporateSecretary.Workflow.Layouts.SPVisionet.CorporateSecretary.Workflow.BuktiSetorCT.BuktiSetorCT"
    CodeBehind="BuktiSetorCT.aspx.cs" %>
        ...
        <table border="0" width="100%">
            <tr>
             ...
             <tr>
                ...
                <td>
                    <asp:CheckBox ID="chkBuktiSetor" runat="server" />
                </td>
            </tr>
            <tr>
                <td>
