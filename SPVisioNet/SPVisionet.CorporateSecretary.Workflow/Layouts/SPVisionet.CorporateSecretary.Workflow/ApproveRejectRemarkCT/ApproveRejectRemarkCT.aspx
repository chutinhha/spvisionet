...
<%@ Page Language="C#" DynamicMasterPageFile="~masterurl/default.master" AutoEventWireup="true"
    Inherits="SPVisionet.CorporateSecretary.Workflow.Layouts.SPVisionet.CorporateSecretary.Workflow.ApproveRejectRemarkCT.ApproveRejectRemarkCT"
    CodeBehind="ApproveRejectRemarkCT.aspx.cs" %>
    ...
    <fieldset>
        ...
        <table border="0" width="100%">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtRemarks" runat="server" Columns="50" Rows="5" TextMode="MultiLine" />
                </td>
            </tr>
            <tr>
                <td>
